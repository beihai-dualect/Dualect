...
namespace flutter_inappwebview_plugin
{
  ...
  public:
    ...
    void setSurfaceSize(double width, double height, double scale_factor);
    void setPosition(double x, double y, double scale_factor);
    ...
    void sendScroll(double offset, bool horizontal, bool isPrecision);
    void setScrollDelta(double delta_x, double delta_y, bool isPrecision);
    void scrollBy(double delta_x, double delta_y) const;
